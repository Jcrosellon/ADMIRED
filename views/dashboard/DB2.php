...
$query = "INSERT INTO usuarios (NOMBRE, APELLIDO, USUARIO, TIPO_DOCUMENTO_ID, NO_DOCUMENTO, FECHA_NACIMIENTO, EMAIL, TELEFONO, CARGO_ID, TORRE, APTO) 
VALUES ('$nombre', '$apellido', '$usuario', '$tipoDocumento', '$numeroDocumento', '$fechaNacimiento', '$correo', '$telefono', '$cargo', '$torre', '$apto')";
...
header("Location: /Admired_principal-main/?c=login&m=index", true, 301);
