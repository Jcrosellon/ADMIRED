                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive mt-2">
                                                    <table
                                                        class="table table-border table-hover table striped cursor-pointer">
                                                        <form
                                                            action="views/dashboard/show.php?userId=<?php echo $_GET['userId'] ?>"
                                                            ...
                                                            <input class="controls" type="text" name="usuario"
                                                                id="usuario" placeholder="Ingrese su Apellido"
                                                            ...
                                                            <input class="controls" type="text" name="no_documento"
                                                                id="no_documento"
                                                                placeholder="Ingrese su Nuemero de Documento"
                                                                value="<?php echo $user['NO_DOCUMENTO'] ?>">
                                                            <input class="controls" type="text" name="fecha_nacimiento"
                                                                id="fecha_nacimiento"
